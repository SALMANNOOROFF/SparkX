<?php
// admin/users_active.php
require_once __DIR__ . '/../config/config.php';
requireAdminLogin();

$page_title = 'Active Customers';
$users = $pdo->query("SELECT * FROM users WHERE is_active = 1 ORDER BY created_at DESC")->fetchAll();
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="admin-page-heading py-3 mb-4">
                <h4 class="fw-bold"><span class="text-muted fw-light">Users /</span> Active Customers</h4>
            </div>

            <div class="card admin-table-card">
                <h5 class="card-header">Active Customer List</h5>
